...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="input-field">
        ...
        <input type="text" <?php if(session('success')): ?> value="<?php echo e(session('data')->agent_id); ?>" <?php endif; ?> style="width: 100%" class="form-control" readonly><br>
        <label>Password</label><br>
        <input type="text" <?php if(session('success')): ?> value="<?php echo e(session('data')->visible_password); ?>" <?php endif; ?> style="width: 100%" class="form-control" readonly>
    </div>
</div>
