                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-bordered card-preview">
                        <div class="card-inner">
                            <form method="POST" action="<?php echo e(url('agents/edit')); ?>/<?php echo e($data->id); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row g-4">
                                    <div class="col-lg-4">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control form-select <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="gender">
                                                    <option value="Male" <?php if($data->gender=='Male'): ?> selected <?php endif; ?>>Male</option>
                                                    <option value="Female" <?php if($data->gender=='Female'): ?> selected <?php endif; ?>>Female</option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>" readonly value="<?php echo e($data->agent_id); ?>" name="agent_id" placeholder="" id="full-name-1">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data->email); ?>" name="email" placeholder="" id="full-name-1">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($data->pan_number); ?>" name="pan_number" placeholder="" id="full-name-1">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control <?php $__errorArgs = ['visible_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
