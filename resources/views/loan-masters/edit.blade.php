                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-bordered card-preview">
                        <div class="card-inner">
                            <form method="POST" action="{{url('loan-types/edit')}}/{{$data->id}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row g-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="file" class="form-control @error('image') is-invalid @enderror" value="{{old('image')}}" onchange="showImg(this)" name="image" placeholder="eg. Personal Loan" id="full-name-1">
                                            <img @if($data->image!=null) src="{{url('storage/app')}}/{{$data->image}}" @endif style="margin-top: 10px;width:100px;">
                                            @error('image')
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('additional_text') is-invalid @enderror" value="{{old('additional_text',$data->additional_text)}}" name="additional_text" placeholder="eg. Starting ROI @ 10.40%" id="full-name-11">
