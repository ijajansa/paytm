                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-bordered card-preview">
                        <div class="card-inner">
                            <form method="POST" action="{{url('loan-documents/add')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row g-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" name="name" placeholder="eg. Aadhar Card" id="full-name-1">
                                            @error('name')
